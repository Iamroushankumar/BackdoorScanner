package com.example.lue.backdoorscanner.ui;
...
import com.example.lue.backdoorscanner.callback.IScanCallback;
import com.example.lue.backdoorscanner.model.JunkGroup;
import com.example.lue.backdoorscanner.model.JunkInfo;
import com.example.lue.backdoorscanner.task.OverallScanTask;
import com.example.lue.backdoorscanner.task.ProcessScanTask;
import com.example.lue.backdoorscanner.task.SysCacheScanTask;
import com.example.lue.backdoorscanner.ui.view.ListHeaderView;
import com.example.lue.backdoorscanner.util.CleanUtil;
...
public class JunkCleanActivity extends BaseActivity {
                ...
                switch (msg.what) {
                    ...
                    case MSG_SYS_CACHE_CLEAN_FINISH:
                        ...
                        if (bundle != null) {
                            ...
                            if (hanged) {
                                Toast.makeText(JunkCleanActivity.this, "Cleaning system cache abnormalities！", Toast.LENGTH_SHORT)
                                        .show();
                            }
                        }
                        break;
    ...
    private void checkScanFinish() {
        ...
        if (mIsProcessScanFinish && mIsSysCacheScanFinish && mIsOverallScanFinish) {
            ...
            mHeaderView.mProgress.setText("Found: " + totalSize);
